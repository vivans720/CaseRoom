          ...
          <div className="mx-auto w-full max-w-sm">
            ...
            <div className="mb-5">
              <p className="text-xs font-bold uppercase tracking-wider text-[#5B4CF3]">
                {authStep === "otp" ? "ONE-TIME PASSCODE" : "GET STARTED"}
              </p>
              <h3 className="mt-1 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">
                {authStep === "otp" ? "Enter Verification Code" : "Create your account"}
              </h3>
            ...
            <RegisterForm onStepChange={setAuthStep} />
